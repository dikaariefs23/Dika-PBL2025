  ...
  return (
    <section className="bg-gray-50 py-20 min-h-screen">
      <div className="max-w-5xl mx-auto text-center px-4">
        <h1 className="text-4xl font-bold text-green-700 mb-6">Untuk Siapa Schóle Fitrah?</h1>
        <p className="text-lg text-slate-600 mb-10">
          Schóle Fitrah ditujukan bagi seluruh keluarga, pendidik, dan komunitas yang ingin menumbuhkan fitrah manusia secara utuh.
        </p>
